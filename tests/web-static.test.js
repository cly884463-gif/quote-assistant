...
assert.ok(html.indexOf("./vendor/exceljs.min.js") < html.indexOf("./excel-export.js"));
assert.ok(html.indexOf("./excel-export.js") < html.indexOf("./app.js"));
...
assert.ok(js.includes("data-action=\"needs-tinting\""));
assert.ok(js.includes("type=\"checkbox\""));
assert.ok(js.includes("需要调色（+¥50/颜色）"));
assert.ok(js.includes("referenceColor: referenceColorInput ? referenceColorInput.value.trim() : \"\""));
assert.ok(js.includes("needsTintingFee: needsTintingInput ? needsTintingInput.checked : false"));
...
assert.ok(js.includes("function handleCustomReferenceInput(card)"));
assert.ok(js.includes("customPriceInput.value = \"\""));
assert.ok(js.includes("quantityInput.value = 0"));
assert.ok(js.includes("needsTintingInput.checked = false"));
...
assert.ok(html.includes("id=\"shippingAddress\""));
assert.ok(js.includes("state.shippingAddress"));
assert.ok(css.includes(".summary-address-control"));
...
assert.ok(css.includes(".custom-tinting-fee-control"));
