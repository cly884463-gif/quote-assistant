...
assert.deepStrictEqual(customTintingPaste.specRows.map((row) => row.spec), ["2.4KG", "5KG", "18KG"]);
assert.deepStrictEqual(customTintingPaste.specRows[0].cells, ["2.4KG", "2.4KG", "可填", "可填"]);
